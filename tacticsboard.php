...
while ( $row = $results->fetchArray() ) {
    ...
    if ( $row['load'] >= 70 ) { $LINESTYLE = 'OVERLOAD70'; };
    if ( $row['load'] >= 80 ) { $LINESTYLE = 'OVERLOAD80'; };
    ...
    if ( $LINESTYLE == 'DEAD' ) {
	    ...
	    echo "<td align=right><div class=$LINESTYLE style='background-color: lightgreen;'><span>".$printlisteners."</span></div></td>";
    }
    }
    }
    echo "</tr>\n";
